...
| BigQuery | Parquet | 说明 | 示例 |
|----------|---------|------|------|
| INT64 | INT64 | 64 位有符号整数 | 12345 |
| FLOAT / FLOAT64 | DOUBLE | 64 位双精度浮点数 | 3.1415 |
| NUMERIC | DECIMAL | 高精度十进制，记录 precision/scale | NUMERIC(10,2) |
| STRING | STRING (UTF8) | Unicode 字符串 | "hello" |
| BOOLEAN | BOOLEAN | 1 字节存储 | TRUE/FALSE |
| TIMESTAMP | TIMESTAMP(MICROS) | 微秒级时间戳 | 1696161600000000 |
| DATE | INT32 (DATE) | Unix 纪元天数 | 738274 |
| TIME | INT32 (TIME(MICROS)) | 微秒数 | 45296789000 |
| BYTES | BINARY | 二进制数据 | Base64 编码 |
| STRUCT | STRUCT | 嵌套结构体，递归映射 | — |
| ARRAY | LIST | 数组类型 | — |
